...
class Ticket with _$Ticket {
  const factory Ticket({
    ...
    String? assigneeId,
    String? assigneeName,
    @JsonKey(unknownEnumValue: TicketStatus.open) @Default(TicketStatus.open) TicketStatus status,
    @JsonKey(unknownEnumValue: TicketPriority.medium) @Default(TicketPriority.medium) TicketPriority priority,
