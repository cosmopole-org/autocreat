...
@freezed
class FlowInstance with _$FlowInstance {
  const factory FlowInstance({
    required String id,
    required String flowId,
    required String companyId,
    String? currentNodeId,
    @Default(InstanceStatus.active) InstanceStatus status,
    required String startedById,
    DateTime? createdAt,
    DateTime? updatedAt,
  }) = _FlowInstance;

  factory FlowInstance.fromJson(Map<String, dynamic> json) =>
      _$FlowInstanceFromJson(json);
}
