...
class CompanyRepository {
  ...
  Future<List<Map<String, dynamic>>> listMembers(String companyId) async {
    try {
      final response = await _apiClient
          .get('${AppConstants.companiesEndpoint}/$companyId/members');
      final list = response.data as List<dynamic>;
  ...
  Future<void> addMember(
      String companyId, String userId, String roleId) async {
    try {
      await _apiClient.post(
        '${AppConstants.companiesEndpoint}/$companyId/members',
  ...
  Future<void> removeMember(String companyId, String userId) async {
    try {
      await _apiClient.delete(
          '${AppConstants.companiesEndpoint}/$companyId/members/$userId');
    } on DioException catch (e) {
      throw ApiException.fromDioError(e);
    }
  }
